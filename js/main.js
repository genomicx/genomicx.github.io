...
function updateToggleActive(theme) {
...
function createAppCard(app) {
  ...
  card.innerHTML = `
    ...
    <div class="app-card-footer">
      ${app.demoUrl ? `<a href="${app.demoUrl}" target="_blank" rel="noopener" class="btn btn-primary">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
        Try Demo
      </a>` : `<span class="btn btn-primary" style="opacity:0.4;cursor:default;">Coming Soon</span>`}
      ${app.sourceUrl ? `<a href="${app.sourceUrl}" target="_blank" rel="noopener" class="btn btn-secondary">
